...
public class telaIdade extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtAnoNasc.setModel(new javax.swing.SpinnerNumberModel(1900, 1900, 2017, 1));
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/Calculadora.jpg"))); // NOI18N
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(lblAnoAtual, javax.swing.GroupLayout.PREFERRED_SIZE, 61, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btnCalcActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalcActionPerformed
        ...
        int ano = Integer.parseInt(txtAnoNasc.getValue().toString());//Converte
        int year = c.get(Calendar.YEAR); // Pega o Ano
        int id = year - ano; // Calcula Idade
        lblAnoAtual.setText(Integer.toString(year));//Altera campo de idade
        lblIdade.setText(Integer.toString(id)); // Altera campo de idade
